...
const App: React.FC = () => {
    ...
    const [coloredBMI, setColorBMI] = useState<string>();
                        ...
                        <IonRow>
                            <IonCol size-sm="8" offset-sm="2" size-md="6" offset-md="3">
                                <IonGrid className="ion-no-padding">
                                    ...
                                    {calculatedBMI && categoryBMI && coloredBMI &&(
                                        <BmiResult calculatedBMIValue={calculatedBMI} categorizedBMI={categoryBMI} coloredCardBMI={coloredBMI}/>
                                    )}
                                </IonGrid>
                            </IonCol>
                        </IonRow>
